...
critical line to much higher precision, from Ref.~\cite{SchaichLoinaz2009}
through several successively improved analyses, most recently the
high-precision continuum determination of Ref.~\cite{DurrKiel2025};
...
would reduce the dynamic exponent to $z \approx 0.25$ for this universality
class and correspondingly tighten the $\nu$ estimate, but
