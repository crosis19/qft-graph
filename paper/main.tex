...
% ---------------------------------------------------------------------------
% PENDING PERMISSION -- do NOT uncomment until D. Schaich confirms in writing
% (request drafted in docs/schaich_email_draft.md). Wording deliberately
% acknowledges his comments without implying he endorses the conclusions.
% We thank D.~Schaich for helpful comments on the finite-size scaling analysis.
% ---------------------------------------------------------------------------
Generative AI was used in the preparation of this work. Anthropic's Claude
(Claude Code, Opus~4 series) assisted with implementing and testing the
...
number is regenerated from the archived data by committed scripts, and all
references were verified against the published records; the author directed the
work and takes full responsibility for its content. Pre-submission feedback was
obtained from ChatGPT (OpenAI) and Gemini (Google), which informed revisions to
the presentation.
\end{acknowledgments}
