...
finite-size scaling---order-parameter S-curves, susceptibility-peak growth, and
correlation-length crossings that recover the exact Ising exponents once a
cluster sampler controls the critical slowing down of local updates---validating
the training distributions. The bipartite
...
finite-size scaling---recovering the exact critical exponents with a cluster
sampler that removes the critical-slowing-down bias of local updates---validating
the ensembles the model is trained on. Comparison
