...
\ifanonymous
% Third-party thanks omitted for double-anonymous review (identity-adjacent);
% restored on acceptance, per the IOP anonymisation checklist.
\else
We thank D.~Schaich for helpful comments on the finite-size scaling analysis.
% ^ Permission granted in writing (2026-08-03); wording deliberately does not
%   imply he endorses the conclusions.
\fi
