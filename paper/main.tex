...
\ifanonymous
% TODO before submitting double-anonymous: create the anonymized mirror at
% https://anonymous.4open.science (point it at the project repository)
% and replace the placeholder URL below. `make anonymous` warns while the
...
\url{https://anonymous.4open.science/r/qft-graph-XXXX} (identifying
