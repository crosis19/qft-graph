...
finite-size scaling---$\gamma/\nu = \ClGammaNu$ and $\nu = \ClNu$, consistent
with the exact Ising values, once a cluster sampler removes the
critical-slowing-down bias of local updates---validating the ensembles the model
is trained on. Comparison
